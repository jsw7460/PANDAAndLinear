...
parser.add_argument("--range_l", type=str, default="4.30")
parser.add_argument("--range_r", type=str, default="4.30")
...
if __name__ == "__main__":
    ...
    # with open("../Pandamodels/globalrlmodels/" + global_file_name + ".torchmodel", "rb") as f:
    #     tmp = torch.load(f)
